 ...
 */
public final class PdfApplicationGenerator2 {
	private PdfApplicationGenerator2() {
	}
	...
	public static File generateFile(Project sonarProject, FileSystem sonarFileSystem, String sonarUrl,
		...
		try {
			...
			// PDImageXObject primagazLogo =
			// PDImageXObject.createFromFile("/home/gujou/Desktop/Desktop/ImagesDoc/primagaz.png",
			// doc);
			...
			PDImageXObject icon_screen = PDImageXObject.createFromFile("/home/gujou/Pictures/icon_flat/Screen TV-52.png",
					doc);
			
			PDImageXObject icon_screenSimple = PDImageXObject.createFromFile("/home/gujou/Pictures/icon_flat/Screen_Pion-52.png",
					doc);
			
			PDImageXObject icon_screenMedium = PDImageXObject.createFromFile("/home/gujou/Pictures/icon_flat/Screen_Cheval-52.png",
					doc);
			
			PDImageXObject icon_screenComplex = PDImageXObject.createFromFile("/home/gujou/Pictures/icon_flat/Screen_Queen-52.png",
					doc);
			
			PDImageXObject icon_xmlTotal = PDImageXObject.createFromFile("/home/gujou/Pictures/icon_flat/Conf_File-50.png",
					doc);
			
			PDImageXObject icon_xmlSimple = PDImageXObject.createFromFile("/home/gujou/Pictures/icon_flat/Conf_File_simple-50.png",
					doc);
			
			PDImageXObject icon_xmlMedium = PDImageXObject.createFromFile("/home/gujou/Pictures/icon_flat/Conf_File_medium-50.png",
					doc);
			
			PDImageXObject icon_xmlComplex = PDImageXObject.createFromFile("/home/gujou/Pictures/icon_flat/Conf_File_complex-50.png",
					doc);
			
			PDImageXObject icon_mulesoftOut = PDImageXObject.createFromFile("/home/gujou/Pictures/icon_flat/icon-mulesoftm-out.png",
					doc);
			PDImageXObject icon_mulesoftIn = PDImageXObject.createFromFile("/home/gujou/Pictures/icon_flat/icon-mulesoftm-in.png",
					doc);
			
			PDImageXObject icon_mulesoftFlow = PDImageXObject.createFromFile("/home/gujou/Pictures/icon_flat/icon-mulesoftm-flow.png",
					doc);
...
//			title("", font, 26, doc);
			...
			attribute(icon_date, 22, 22, simpleDateFormat.format(new Date()), fontItalic, 15, doc, DEFAULT_TEXT_COLOR); //  TODO switch field & value : resource => date
			...
			attribute(icon_lines, 22, 22, sonarMeasures.get("lines"),true, " lines", font, 15, doc); // lines => TODO
			attribute(icon_classes, 22, 22, sonarMeasures.get("classes"),true, " classes", font, 15, doc); // classes
			attribute(icon_files, 22, 22, sonarMeasures.get("files"),true, " files", font, 15, doc); // files => TODO
			...
			attribute(icon_accessors, 22, 22, sonarMeasures.get("accessors"),true, " getters and setters", font, 15, doc); //accessors
			...
			attribute(icon_codeGenerated, 22, 22, sonarMeasures.get("generated_ncloc"),true, " generated code lines", font, 15, doc); // generated_ncloc
			attribute(icon_linesGenerated, 22, 22, sonarMeasures.get("generated_lines"),true, " generated lines", font, 15, doc); // generated_lines
			...
			if (xmlComplexNbTotal !=null){
				attribute(icon_xmlComplex, 22, 22, xmlComplexNbTotal, true, xmlComplexNbTotal.getLabel(), font, 15, doc);
			}
			...
			if (muleNbRequestField !=null){
				attribute(icon_mulesoftIn, 22, 22, muleNbRequestField, true, muleNbRequestField.getLabel(), font, 15, doc);
			}
			if (muleNbFlow !=null){
			...
			attribute(icon_packagecycle, 22, 22, sonarMeasures.get("package_cycles"),true, " package cycles detected", font, 15, doc); //package_cycles
			attribute(icon_cut_files, 22, 22, sonarMeasures.get("package_tangles"),true, " file dep. to cut cycles ", font, 15, doc, sonarMeasures.get("package_tangle_index"), true); //package_tangles + TODO package_tangle_index X
			attribute(icon_cut_directories, 22, 22, sonarMeasures.get("package_feedback_edges"),true, " package dep. to cut cycles", font, 15, doc); //package_feedback_edges
			attribute(icon_chain, 22, 22, sonarMeasures.get("package_edges_weight"),true, " file dep. betw. packages", font, 15, doc); //package_edges_weight X

			
			title("Complexity", font, 26, doc);
			attribute(icon_complexity, 22, 22, sonarMeasures.get("complexity"),true, " complexity index", font, 15, doc); // complexity
			attribute(icon_complexityClass, 22, 22, sonarMeasures.get("class_complexity"),true, " complexity index by class", font, 15, doc); // class_complexity
			attribute(icon_complexityFile, 22, 22, sonarMeasures.get("file_complexity"),true, " complexity index by file", font, 15, doc); // file_complexity
			attribute(icon_complexityMethod, 22, 22, sonarMeasures.get("function_complexity"),true, " complexity index by method", font, 15, doc); // function_complexity
			
			title("Duplications", font, 26, doc);
			attribute(icon_duplicate_lines, 22, 22, sonarMeasures.get("duplicated_lines"),true, " duplicated lines", font, 15, doc, sonarMeasures.get("duplicated_lines_density"), true); // duplicated_lines + duplicated_lines_density
			attribute(icon_duplicate, 22, 22, sonarMeasures.get("duplicated_files"),true, " involved files", font, 15, doc); // duplicated_files
			attribute(icon_duplicate_packages, 22, 22, sonarMeasures.get("duplicated_blocks"),true, " duplicated blocks", font, 15, doc); // duplicated_blocks
			
			title("Sonarqube Issues", font, 26, doc);

			attribute(icon_bug, 22, 22, sonarMeasures.get("violations"),true, " issues", font, 15, doc); // violations + new method for new_violations
			attribute(icon_poison, 22, 22, sonarMeasures.get("blocker_violations"),true, " blocker issues", font, 15, doc); // blocker_violations + new method for new_blocker_violations
			attribute(icon_fire, 22, 22, sonarMeasures.get("critical_violations"),true, " critical issues", font, 15, doc); // critical_violations + new method for new_critical_violations
			attribute(icon_major, 22, 22, sonarMeasures.get("major_violations"),true, " major issues", font, 15, doc); // major_violations + new method for new_major_violations
			attribute(icon_minor, 22, 22, sonarMeasures.get("minor_violations"),true, " minor issues", font, 15, doc); // minor_violations + new method for new_minor_violations
...
//			attribute(icon_balance, 22, 22, "533", " rules compliance index", font, 15, doc); // violations_density
			...
			if (squaleIndexMeasure != null){
				attribute(icon_debt, 22, 22, squaleIndexMeasure.getFrmt_val(), " Sqale technical debt", font, 15, doc, null, false, SMILE_ORANGE_COLOR); // sqale_index
			}

			title("Documentation", font, 26, doc);

			attribute(icon_comments, 22, 22, sonarMeasures.get("comment_lines"),true, " comment lines", font, 15, doc, sonarMeasures.get("comment_lines_density"), true); // comment_lines + comment_lines_density
			...
			if (publicApiUndocMeasure != null) {
				...
				attribute(icon_javadoc, 22, 22, publicApiUndocMeasure, true, " public undoc. API",
						font, 15, doc, new Measure(publicApiUndocDensity), true); // public_undocumented_api
																		// + (1
																		// -
			...
			attribute(icon_vulnerability_high, 22, 22, sonarMeasures.get("high_severity_vulns"), true, " high dep. vulnerabilities", font, 15, doc);
			attribute(icon_vulnerability_medium, 22, 22, sonarMeasures.get("medium_severity_vulns"), true, " medium dep. vulnerabilities", font, 15, doc);
			attribute(icon_vulnerability_low, 22, 22, sonarMeasures.get("low_severity_vulns"), true, " low dep. vulnerabilities", font, 15, doc);
			...
			if (testsMeasure == null){
				...
				attribute(icon_tests_cover, 22, 22, "0", " covered lines", font, 15, doc, "0", true, SMILE_ORANGE_COLOR);
			} else {
				...
				try {
					...
					int failureTests = failureTestsMeasure!=null? (int) Double.parseDouble(failureTestsMeasure.getVal()):0;
					int errorTests = errorTestsMeasure!=null? (int) Double.parseDouble(errorTestsMeasure.getVal()):0;
					...
					String successPercent = successPercentMeasure!=null?successPercentMeasure.getVal():decimalFormat.format((successTests * 100) / nbTests);
					
					attribute(icon_tests_success, 22, 22, Integer.valueOf(successTests).toString(), " tests in success", font, 15, doc, successPercent, true, SMILE_ORANGE_COLOR);
					attribute(icon_tests_fail, 22, 22, Integer.valueOf(failureTests).toString(), " tests in failure", font, 15, doc, decimalFormat.format(failurePercent), true, SMILE_ORANGE_COLOR);
					attribute(icon_tests_error, 22, 22, Integer.valueOf(errorTests).toString(), " tests in error", font, 15, doc, decimalFormat.format(errorPercent), true, SMILE_ORANGE_COLOR);
					...
					int totalLineToCover = totalLineToCoverMeasure!=null? (int) Double.parseDouble(totalLineToCoverMeasure.getVal()):0;
					if (coveragePercentMeasure != null){
						attribute(icon_tests_cover, 22, 22, Integer.valueOf(totalLineToCover - uncover).toString(), " covered lines", font, 15, doc, coveragePercentMeasure.getVal(), true, SMILE_ORANGE_COLOR);
					} else {
						attribute(icon_tests_cover, 22, 22, "0", " covered lines", font, 15, doc, "0", true, SMILE_ORANGE_COLOR);
					}
...
//			attribute(icon_tests, 22, 22, sonarMeasures.get("tests"), " unit tests", font, 15, doc); //tests + TODO test_execution_time
//			attribute(icon_tests_success, 22, 22, "0", " tests in success", font, 15, doc, sonarMeasures.get("test_success_density"), true); // calcul success + test_success_density
//			attribute(icon_tests_fail, 22, 22, "0", " tests in failure", font, 15, doc); // test_failures + calcul fail density
//			attribute(icon_tests_error, 22, 22, "0", " tests in error", font, 15, doc); // test_errors + calcul error density
//			attribute(icon_tests_skip, 22, 22, "0", " tests skipped", font, 15, doc); // skipped_tests 
//			attribute(icon_tests_cover, 22, 22, sonarMeasures.get("line_coverage"), " covered lines", font, 15, doc, sonarMeasures.get("lines_to_cover"), true); // line_coverage => lines_to_cover
...
//		stream.setNonStrokingColor(DEFAULT_TEXT_COLOR);
	...
	private static void attribute(PDImageXObject logo, int logoHeight, int logoWidth, Measure measure, boolean isInt, String label,
	...
	private static void attribute(PDImageXObject logo, int logoHeight, int logoWidth, Measure measure, boolean isInt, String label,
			PDFont font, int fontSize, PDDocument doc, Measure attribute, boolean isPercent) throws IOException {
		...
		if (measure != null){
			...
			if (attribute != null){
				attribute(logo, logoHeight, logoWidth, value, label, font, fontSize, doc, attribute.getVal(), isPercent, SMILE_ORANGE_COLOR);
			} else {
				attribute(logo, logoHeight, logoWidth, value, label, font, fontSize, doc, null, false, SMILE_ORANGE_COLOR);
			}
		}
	}
