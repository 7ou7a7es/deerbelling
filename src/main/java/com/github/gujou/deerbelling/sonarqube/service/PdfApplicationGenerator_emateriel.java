 ...
 */
public final class PdfApplicationGenerator_emateriel {
	private PdfApplicationGenerator_emateriel() {
	}
...
//			title("", font, 26, doc);
			...
			attribute(icon_date, 22, 22, " 22 Septembre 2016", fontItalic, 15, doc, DEFAULT_TEXT_COLOR); //  TODO switch field & value : resource => date
			...
			attribute(icon_ncloc, 22, 22, "20860", " lines of code", font, 15, doc); // ncloc
			attribute(icon_lines, 22, 22, "25950", " lines", font, 15, doc); // lines => TODO
			attribute(icon_classes, 22, 22, "153", " classes", font, 15, doc); // classes
			attribute(icon_files, 22, 22, "151", " files", font, 15, doc); // files => TODO
			attribute(icon_folders, 22, 22, "11", " directories", font, 15, doc); // directories
			attribute(icon_packages, 22, 22, "1", " modules", font, 15, doc); // projects
			attribute(icon_methods, 22, 22, "1222", " methods", font, 15, doc); //functions
			attribute(icon_accessors, 22, 22, "1528", " getters and setters", font, 15, doc); //accessors
			attribute(icon_api, 22, 22, "1223", "  public API", font, 15, doc); //public_api
			attribute(icon_keyring, 22, 22, "10179", " statements", font, 15, doc); //statements
			...
			attribute(icon_screen, 22, 22, "35", " pages xhtml", font, 15, doc); // generated_lines
			attribute(icon_screenSimple, 22, 22, "6", " simple pages xhtml", font, 15, doc); // generated_lines
			attribute(icon_screenMedium, 22, 22, "9", " medium pages xhtml", font, 15, doc); // generated_lines
			attribute(icon_screenComplex, 22, 22, "20", " complex pages xhtml", font, 15, doc); // generated_lines
			
			
			title("Design", font, 26, doc);
			attribute(icon_packagecycle, 22, 22, "25", " package cycles detected", font, 15, doc); //package_cycles
			attribute(icon_cut_files, 22, 22, "26", " file dep. to cut cycles ", font, 15, doc, "12.4", true); //package_tangles + TODO package_tangle_index X
			attribute(icon_cut_directories, 22, 22, "8", " package dep. to cut cycles", font, 15, doc); //package_feedback_edges
			attribute(icon_chain, 22, 22, "419", " file dep. betw. packages", font, 15, doc); //package_edges_weight X

			
			title("Complexity", font, 26, doc);
			attribute(icon_complexity, 22, 22, "3939", " complexity index", font, 15, doc); // complexity
			attribute(icon_complexityClass, 22, 22, "25.7", " complexity index by class", font, 15, doc); // class_complexity
			attribute(icon_complexityFile, 22, 22, "26.1", " complexity index by file", font, 15, doc); // file_complexity
			attribute(icon_complexityMethod, 22, 22, "3.2", " complexity index by method", font, 15, doc); // function_complexity
			
			title("Duplications", font, 26, doc);
			attribute(icon_duplicate_lines, 22, 22, "1334", " duplicated lines", font, 15, doc, "5.1", true); // duplicated_lines + duplicated_lines_density
			attribute(icon_duplicate, 22, 22, "25", " involved files", font, 15, doc); // duplicated_files
			attribute(icon_duplicate_packages, 22, 22, "85", " duplicated blocks", font, 15, doc); // duplicated_blocks
			
			title("Sonarqube Issues", font, 26, doc);

			attribute(icon_bug, 22, 22, "1820", " issues", font, 15, doc); // violations + new method for new_violations
			attribute(icon_poison, 22, 22, "32", " blocker issues", font, 15, doc); // blocker_violations + new method for new_blocker_violations
			attribute(icon_fire, 22, 22, "88", " critical issues", font, 15, doc); // critical_violations + new method for new_critical_violations
			attribute(icon_major, 22, 22, "1107", " major issues", font, 15, doc); // major_violations + new method for new_major_violations
			attribute(icon_minor, 22, 22, "571", " minor issues", font, 15, doc); // minor_violations + new method for new_minor_violations
...
//			attribute(icon_balance, 22, 22, "533", " rules compliance index", font, 15, doc); // violations_density
			attribute(icon_debt, 22, 22, "30 days", " of technical debt", font, 15, doc); // sqale_index

			title("Documentation", font, 26, doc);

			attribute(icon_comments, 22, 22, "1865", " comment lines", font, 15, doc, "0.8", true); // comment_lines + comment_lines_density
			attribute(icon_javadoc, 22, 22, "1202", " public undoc. API", font, 15, doc, "100", true); // public_undocumented_api + (1 - public_documented_api_density %)

			title("OWASP plugin", font, 26, doc);

			attribute(icon_vulnerability_high, 22, 22, "4", " high dep. vulnerabilities", font, 15, doc);
			attribute(icon_vulnerability_medium, 22, 22, "26", " medium dep. vulnerabilities", font, 15, doc);
			attribute(icon_vulnerability_low, 22, 22, "2", " low dep. vulnerabilities", font, 15, doc);
