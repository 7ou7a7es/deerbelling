...
//				TasksReportKeys.TASKS_REPORT_TYPE_XLS_EXTENSION }),
		@Property(key=TasksReportKeys.TASKS_REPORT_TYPE_CSV_SEPARATOR_KEY, name = "Separator", description = "The CSV Separator.", defaultValue = TasksReportKeys.TASKS_REPORT_TYPE_CSV_SEPARATOR_DEFAULT, global = true, project = true, module = false),
